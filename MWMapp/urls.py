...
path('approve-worker', views.admin_approve_worker, name='approve-worker'),
    ...
    #  path('create-pdf/<int:id>',views.create_pdf,name="create-pdf"),
...
path('workerviewreport',views.workerviewreport,name='workerviewreport'),
...
# ----jobprovider-reg---
path('jbviewworkers',views.jbviewworkers,name='jbviewworkers'),

path('viewprofile2',views.viewprofile2,name='viewprofile2'),
...
# ----insurance-reg---
path('viewprofile3',views.viewprofile3,name='viewprofile3'),
